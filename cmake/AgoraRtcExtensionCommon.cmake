...
function(agora_rtc_extension_add_library)
    cmake_parse_arguments(AGORA_RTC_EXT
        ""
        "PLATFORM;SDK_INCLUDE_DIR;AOSL_HEADERS_DIR"
        "FRAMEWORKS"
        ${ARGN}
    )
    ...
    target_include_directories(AgoraRtcExtension PUBLIC
        ${AGORA_RTC_EXT_SDK_INCLUDE_DIR}
        ${AGORA_RTC_EXT_AOSL_HEADERS_DIR}
        ...
        ${COCOS_X_PATH}/external/${AGORA_RTC_EXT_PLATFORM}/include
        ${COCOS_X_PATH}/external/${AGORA_RTC_EXT_PLATFORM}/include/v8
        ${COCOS_X_PATH}
        ${COCOS_X_PATH}/cocos
