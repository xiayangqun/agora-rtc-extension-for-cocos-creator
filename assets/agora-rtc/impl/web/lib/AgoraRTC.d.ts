...
interface IAudioProcessor extends IBaseProcessor {}

interface IExtension<T = any> {
    readonly name?: string;
    readonly version?: string;
    createProcessor?: (...args: any[]) => T;
}

declare module "AgoraRTC" {
     ...
     * - `"none"`: No encryption.
     */
    export declare type EncryptionMode =
        | "aes-128-xts"
        | "aes-256-xts"
        | "aes-128-ecb"
        | "sm4-128-ecb"
     ...
     * @event
     */
    declare function event_audio_context_state_changed(
     ...
     * @event
     */
    declare function event_connection_state_change(
        curState: ConnectionState,
        revState: ConnectionState,
        reason?: ConnectionDisconnectedReason,
    ): void;

    declare function event_content_inspect_connection_state_change(
    ...
    declare function event_image_moderation_connection_state_change(
     ...
     * @event
     */
    declare function event_peerconnection_state_change(
     ...
     * @event
     */
    declare function event_user_info_updated(
        uid: UID,
        msg:
            | "mute-audio"
            | "mute-video"
     ...
     * @event
     */
    declare function event_user_published(
     ...
     * @event
     */
    declare function event_user_unpublished(
        user: IAgoraRTCRemoteUser,
        mediaType: "audio" | "video" | "datachannel",
        config?: IDataChannelConfig,
    ): void;
     ...
     * @event
     */
    declare function event_volume_indicator(
        result: {
            /**
    ...
    export declare interface IAgoraRTC extends EventEmitter {
        ...
        createScreenVideoTrack(
            config: ScreenVideoTrackInitConfig,
            withAudio?: "enable" | "disable" | "auto" | ScreenAudioTrackInitConfig,
    ...
    declare interface IElectronNativeImage {
        ...
        resize(options: { width: number }): IElectronNativeImage;
    }
