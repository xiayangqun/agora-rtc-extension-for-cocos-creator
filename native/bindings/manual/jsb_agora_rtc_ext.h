...
class ScopedCString {
public:
    // Allocate a copy of s and track it for later release.
    ...
    // Release all tracked strings. Idempotent — safe to call even if empty.
...
// The destructor frees all ScopedCString::dup'd pointers when the function exits.
// RAII guard — place at the top of any binding function that calls
// sevalue_to_native with struct parameters containing const char* fields.
// The destructor frees all ScopedCString::dup'd pointers when the function exits.
